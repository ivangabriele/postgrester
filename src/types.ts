...
export interface PostgresterInstance {
  ...
  get<T = any>(path: string, withPagesLength?: boolean): Promise<{ data: T; pagesLength: number; totalLength: number }>
  ...
  post(path: string, data: object | object[], upsertOptions?: PostgesterPostUpsertOptions): Promise<void>
